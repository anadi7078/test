@Payment @SNAAcademy @Mobile
Feature: Payment

  @ACAWEB042Mobile @Payment @P1
  Scenario Outline: ACAWEB042 - Checking out courses and paying using Bank Transfer
    ...
    Then verify order confirmation mail is received for "mobile"
  ...
  @ACAWEB044Mobile @Payment @P1 @Regression
