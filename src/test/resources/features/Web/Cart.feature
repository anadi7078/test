...
Feature: Cart
  ...
  @ACAWEB038 @Cart @P1 @DailyCheckList
  Scenario Outline: ACAWEB038 - User can access his empty cart
      ####-pre requisite script started-------####
  ...
  @ACAWEB039 @Cart @P1 @DailyCheckList
  ...
  @ACAWEB040 @Cart @P1 @DailyCheckList
  ...
  @ACAWEB041 @Cart @P1 @DailyCheckList
